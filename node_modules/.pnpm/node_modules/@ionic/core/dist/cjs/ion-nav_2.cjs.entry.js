...
var helpers = require('./helpers-gntk8bfm.js');
var index$1 = require('./index-BS2uhvhT.js');
var ionicGlobal = require('./ionic-global-BerQGEpE.js');
var frameworkDelegate = require('./framework-delegate-BgU6U9Ez.js');
...
const Nav = class {
    ...
    async componentDidLoad() {
        ...
        this.didLoad = true;
        this.rootChanged();
        this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-CuIiziaa.js'); })).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
