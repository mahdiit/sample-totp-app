 ...
 */
export const applyKeyboardFocus = async (page, locator, indicatorLocator = locator) => {
    await expect(async () => {
        await page.evaluate(() => { var _a; return (_a = document.activeElement) === null || _a === void 0 ? void 0 : _a.blur(); });
